    ...
    return (
        <div className="flex flex-col w-full gap-4">
            ...
            <form action="" onSubmit={handleNewEmail} className='bg-gray-50 rounded w-full flex flex-col gap-5 lg:w-1/2 p-5'>
                ...
                <button type="submit" className="text-black bg-yellow-700 !w-fit hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Update</button>
            ...
            <form action="" onSubmit={handleNewPass} className='bg-gray-50 rounded w-full flex flex-col gap-5 lg:w-1/2 p-5'>
                ...
                <button type="submit" className="text-black !w-fit bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Update</button>
